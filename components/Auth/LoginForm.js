...
const LoginForm = ({ onSubmit, switchText, switchHandler }) => {
  ...
  const [eyeIcon, setEyeIcon] = useState("eye-slash"); // State to manage eye icon
  ...
  const handleSocialLogin = async (provider) => {
    switch (provider) {
      case "google":
        ...
        //     webClientId: "1082378657177-r9pliq9e36cj13ir5udukrkliqhv7js9.apps.googleusercontent.com",
        //   });
